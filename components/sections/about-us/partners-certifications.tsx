...
const partnerships = [
  ...
  {
    name: 'AWS Partner',
    color: 'bg-gradient-to-r from-orange-200 to-orange-400 text-secondary-foreground',
  },
  {
    name: 'Microsoft Azure Partner',
    color: 'bg-gradient-to-r from-cyan-200 to-cyan-400 text-secondary-foreground',
  },
];
...
const certifications = [
  ...
  },
  {
    ...
    color: 'bg-gradient-to-r from-red-200 to-red-400 text-secondary-foreground',
  },
  {
