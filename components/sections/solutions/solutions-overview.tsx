    ...
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        <p className="text-center text-lg mb-12 max-w-3xl mx-auto text-primary-dark/80">
          We offer key solutions designed to tackle core business needs. Whether you're looking to
          automate workflows, gain deeper insights from your data, cut costs, or scale your
